...
import (
	...
	"github.com/spectre-project/spectred/app/protocol"
	"github.com/spectre-project/spectred/app/rpc"
	"github.com/spectre-project/spectred/domain"
	"github.com/spectre-project/spectred/domain/consensus"
	"github.com/spectre-project/spectred/domain/utxoindex"
	...
	"github.com/spectre-project/spectred/infrastructure/network/connmanager"
...
// ComponentManager is a wrapper for all the spectred services
...
// Start launches all the spectred services.
...
// Stop gracefully shuts down all the spectred services.
func (a *ComponentManager) Stop() {
	// Make sure this only happens once.
	if atomic.AddInt32(&a.shutdown, 1) != 1 {
		log.Infof("Spectred is already in the process of shutting down")
		return
	}

	log.Warnf("Spectred shutting down")
