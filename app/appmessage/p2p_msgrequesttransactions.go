...
// MsgRequestTransactions implements the Message interface and represents a spectre
...
// NewMsgRequestTransactions returns a new spectre RequestTransactions message that conforms to
