...
// MsgRequestNextPruningPointAndItsAnticoneBlocks implements the Message interface and represents a spectre
...
// NewMsgRequestNextPruningPointAndItsAnticoneBlocks returns a new spectre RequestNextPruningPointAndItsAnticoneBlocks message that conforms to the
// Message interface.
