...
// MsgRequestAnticone implements the Message interface and represents a spectre
...
// NewMsgRequestAnticone returns a new spectre RequestPastDiff message that conforms to the
