...
// MsgDoneHeaders implements the Message interface and represents a spectre
...
// NewMsgDoneHeaders returns a new spectre DoneIBDBlocks message that conforms to the
// Message interface.
