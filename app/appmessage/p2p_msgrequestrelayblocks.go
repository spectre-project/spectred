...
// MsgRequestRelayBlocks implements the Message interface and represents a spectre
...
// NewMsgRequestRelayBlocks returns a new spectre RequestRelayBlocks message that conforms to
