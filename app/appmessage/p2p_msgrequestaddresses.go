...
// MsgRequestAddresses implements the Message interface and represents a spectre
...
// NewMsgRequestAddresses returns a new spectre RequestAddresses message that conforms to the
