...
var DefaultUserAgent = fmt.Sprintf("/spectred:%s/", version.Version())

// MsgVersion implements the Message interface and represents a spectre version
...
// NewMsgVersion returns a new spectre version message that conforms to the
