...
// MsgRequestHeaders implements the Message interface and represents a spectre
...
// NewMsgRequstHeaders returns a new spectre RequestHeaders message that conforms to the
