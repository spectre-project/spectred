...
// MsgTransactionNotFound defines a spectre TransactionNotFound message which is sent in response to
...
// NewMsgTransactionNotFound returns a new spectre transactionsnotfound message that conforms to the
