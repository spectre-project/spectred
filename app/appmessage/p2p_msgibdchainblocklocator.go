...
// MsgIBDChainBlockLocator implements the Message interface and represents a spectre
...
// NewMsgIBDChainBlockLocator returns a new spectre locator message that conforms to
