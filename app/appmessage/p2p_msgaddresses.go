...
// spectre Addresses message (MsgAddresses).
const MaxAddressesPerMsg = 1000

// MsgAddresses implements the Message interface and represents a spectre
// Addresses message.
...
// NewMsgAddresses returns a new spectre Addresses message that conforms to the
