...
// MsgDoneBlocksWithTrustedData implements the Message interface and represents a spectre
...
// NewMsgDoneBlocksWithTrustedData returns a new spectre DoneBlocksWithTrustedData message that conforms to the
// Message interface.
