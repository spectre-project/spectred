...
// MsgRequestNextHeaders implements the Message interface and represents a spectre
...
// NewMsgRequestNextHeaders returns a new spectre RequestNextHeaders message that conforms to the
// Message interface.
