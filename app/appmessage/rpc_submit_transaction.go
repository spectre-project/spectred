...
// RPCTransaction is a spectred transaction representation meant to be
// used over RPC
...
// RPCTransactionInput is a spectred transaction input representation
...
// RPCScriptPublicKey is a spectred ScriptPublicKey representation
type RPCScriptPublicKey struct {
	Version uint16
	Script  string
}

// RPCTransactionOutput is a spectred transaction output representation
// meant to be used over RPC
...
// RPCOutpoint is a spectred outpoint representation meant to be used
// over RPC
...
// RPCUTXOEntry is a spectred utxo entry representation meant to be used
// over RPC
