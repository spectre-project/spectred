...
const miningAddress = "spectredev:qrcqat6l9zcjsu7swnaztqzrv0s7hu04skpaezxk43y4etj8ncwfk9keeuf4y"
...
func runDAATest(t *testing.T, testName string, runDuration time.Duration,
	...
	tearDownSpectred := common.RunSpectredForTesting(t, "spectred-daa-test", rpcAddress)
	defer tearDownSpectred()
