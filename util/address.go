...
import (
	...
	"github.com/spectre-project/spectred/util/bech32"
)
...
const (
	...
	Bech32PrefixSpectreDev

	// Prefix for the test network.
	Bech32PrefixSpectreTest

	// Prefix for the simulation network.
	Bech32PrefixSpectreSim
)
...
var stringsToBech32Prefixes = map[string]Bech32Prefix{
	"spectre":     Bech32PrefixSpectre,
	"spectredev":  Bech32PrefixSpectreDev,
	"spectretest": Bech32PrefixSpectreTest,
	"spectresim":  Bech32PrefixSpectreSim,
}
...
// and a payload which encodes the spectre network and address type. It is used
...
// with the passed spectre network.
