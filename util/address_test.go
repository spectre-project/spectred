...
func TestAddresses(t *testing.T) {
	tests := []struct {
		...
		{
			name:    "mainnet p2pk",
			addr:    "spectre:qr35ennsep3hxfe7lnz5ee7j5jgmkjswsn35ennsep3hxfe7ln35cmeu3evl2",
			encoded: "spectre:qr35ennsep3hxfe7lnz5ee7j5jgmkjswsn35ennsep3hxfe7ln35cmeu3evl2",
			valid:   true,
			result: util.TstAddressPubKey(
				util.Bech32PrefixSpectre,
			...
			f: func() (util.Address, error) {
				publicKey := []byte{
					...
					0xe3, 0x4c, 0xce, 0x70, 0xc8, 0x63, 0x73, 0x27, 0x3e, 0xfc,
					0xe3, 0x4c}
				return util.NewAddressPublicKey(publicKey, util.Bech32PrefixSpectre)
			},
			passedPrefix:   util.Bech32PrefixUnknown,
			expectedPrefix: util.Bech32PrefixSpectre,
		},
		{
			name:    "mainnet p2pk 2",
			addr:    "spectre:qq80qvqs0lfxuzmt7sz3909ze6camq9d4t35ennsep3hxfe7ln35c6un5lvve",
			encoded: "spectre:qq80qvqs0lfxuzmt7sz3909ze6camq9d4t35ennsep3hxfe7ln35c6un5lvve",
			valid:   true,
			result: util.TstAddressPubKey(
				util.Bech32PrefixSpectre,
				[util.PublicKeySize]byte{
			...
			passedPrefix:   util.Bech32PrefixSpectre,
			expectedPrefix: util.Bech32PrefixSpectre,
		},
		{
			name:    "testnet p2pk",
			addr:    "spectretest:qputx94qseratdmjs0j395mq8u03er0x3l35ennsep3hxfe7ln35cjlr90qqm",
			encoded: "spectretest:qputx94qseratdmjs0j395mq8u03er0x3l35ennsep3hxfe7ln35cjlr90qqm",
			valid:   true,
			result: util.TstAddressPubKey(
				util.Bech32PrefixSpectreTest,
				[util.PublicKeySize]byte{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressPublicKey(publicKey, util.Bech32PrefixSpectreTest)
			},
			passedPrefix:   util.Bech32PrefixSpectreTest,
			expectedPrefix: util.Bech32PrefixSpectreTest,
		},

		// ECDSA P2PK tests.
		{
			name:    "mainnet ecdsa p2pk",
			addr:    "spectre:q835ennsep3hxfe7lnz5ee7j5jgmkjswsn35ennsep3hxfe7ln35e2segr9lxpf",
			...
			f: func() (util.Address, error) {
				publicKey := []byte{
					...
					0xe3, 0x4c, 0xce, 0x70, 0xc8, 0x63, 0x73, 0x27, 0x3e, 0xfc,
					0xe3, 0x4c, 0xaa}
				return util.NewAddressPublicKeyECDSA(publicKey, util.Bech32PrefixSpectre)
			},
			passedPrefix:   util.Bech32PrefixUnknown,
			expectedPrefix: util.Bech32PrefixSpectre,
		},
		...
		{
			name:    "mainnet p2sh",
			addr:    "spectre:prq20q4qd9ulr044cauyy9wtpeupqpjv67pn2vyc6acly7xqkrjdzdz5l0c8t",
			...
			f: func() (util.Address, error) {
				script := []byte{
					...
					0xae}
				return util.NewAddressScriptHash(script, util.Bech32PrefixSpectre)
			},
			passedPrefix:   util.Bech32PrefixSpectre,
			expectedPrefix: util.Bech32PrefixSpectre,
		},
		{
			name:    "mainnet p2sh 2",
			addr:    "spectre:pr5vxqxg0xrwl2zvxlq9rxffqx00sm44kn5vxqxg0xrwl2zvxl5vxjzlvqth5",
			encoded: "spectre:pr5vxqxg0xrwl2zvxlq9rxffqx00sm44kn5vxqxg0xrwl2zvxl5vxjzlvqth5",
			valid:   true,
			result: util.TstAddressScriptHash(
				util.Bech32PrefixSpectre,
				[blake2b.Size256]byte{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressScriptHashFromHash(hash, util.Bech32PrefixSpectre)
			},
			passedPrefix:   util.Bech32PrefixSpectre,
			expectedPrefix: util.Bech32PrefixSpectre,
		},
		{
			name:    "testnet p2sh",
			addr:    "spectretest:przhjdpv93xfygpqtckdc2zkzuzqeyj2pt5vxqxg0xrwl2zvxl5vx4tm0lqsu",
			encoded: "spectretest:przhjdpv93xfygpqtckdc2zkzuzqeyj2pt5vxqxg0xrwl2zvxl5vx4tm0lqsu",
			valid:   true,
			result: util.TstAddressScriptHash(
				util.Bech32PrefixSpectreTest,
				[blake2b.Size256]byte{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressScriptHashFromHash(hash, util.Bech32PrefixSpectreTest)
			},
			passedPrefix:   util.Bech32PrefixSpectreTest,
			expectedPrefix: util.Bech32PrefixSpectreTest,
		},
...
func TestDecodeAddressErrorConditions(t *testing.T) {
	tests := []struct {
		...
		{
			"spectresim:raskzctpv9skzctpv9skzctpv9skzctpvy37ct7zafpv9skzctpvyz6wm06l9",
			util.Bech32PrefixSpectreSim,
			"unknown address type",
		},
		{
			"spectresim:raskzcgcjkvxs7m",
			util.Bech32PrefixSpectreSim,
			"unknown address type",
		},
		{
			"spectretest:qqq65mvpxcmajeq44n2n8vfn6u9f8l4zsys5p0c0t8",
			util.Bech32PrefixSpectre,
...
func TestParsePrefix(t *testing.T) {
	tests := []struct {
		...
		{"spectre", util.Bech32PrefixSpectre, false},
		{"spectretest", util.Bech32PrefixSpectreTest, false},
		{"spectresim", util.Bech32PrefixSpectreSim, false},
...
func TestPrefixToString(t *testing.T) {
	tests := []struct {
		...
		{util.Bech32PrefixSpectre, "spectre"},
		{util.Bech32PrefixSpectreTest, "spectretest"},
		{util.Bech32PrefixSpectreSim, "spectresim"},
		{util.Bech32PrefixUnknown, ""},
	}
