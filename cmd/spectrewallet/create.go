...
import (
	...
	"github.com/spectre-project/spectred/cmd/spectrewallet/libspectrewallet/bip32"
...
func create(conf *createConfig) error {
	...
	fmt.Printf("Notice the above is neither a secret key to your wallet " +
		"(use \"spectrewallet dump-unencrypted-data\" to see a secret seed phrase) " +
		"nor a wallet public address (use \"spectrewallet new-address\" to create and see one)\n\n")
	...
	if len(signerExtendedPublicKeys) > 0 {
		cosignerIndex, err = libspectrewallet.MinimumCosignerIndex(signerExtendedPublicKeys, extendedPublicKeys)
		if err != nil {
			return err
		}
	}
