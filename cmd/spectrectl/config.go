...
type configFlags struct {
	...
	AllowConnectionToDifferentVersions bool   `short:"a" long:"allow-connection-to-different-versions" description:"Allow connections to versions different than spectrectl's version'"`
...
func parseConfig() (*configFlags, error) {
	...
	parser.Usage = "spectrectl [OPTIONS] [COMMAND] [COMMAND PARAMETERS].\n\nCommand can be supplied only if --json is not used." +
