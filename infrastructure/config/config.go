...
const (
	defaultConfigFilename      = "spectred.conf"
	defaultLogLevel            = "info"
	defaultLogDirname          = "logs"
	defaultLogFilename         = "spectred.log"
	defaultErrLogFilename      = "spectred_err.log"
	...
	sampleConfigFilename    = "sample-spectred.conf"
	defaultMaxUTXOCacheSize = 5_000_000_000
	defaultProtocolVersion  = 5
)

var (
	// DefaultAppDir is the default home directory for spectred.
	DefaultAppDir = util.AppDir("spectred", false)
...
// Flags defines the configuration options for spectred.
//
...
type Flags struct {
	...
	Listeners                       []string      `long:"listen" description:"Add an interface/port to listen for connections (default all interfaces port: 18111, testnet: 18211)"`
	...
	RPCListeners                    []string      `long:"rpclisten" description:"Add an interface/port to listen for RPC connections (default port: 18110, testnet: 18210)"`
	...
	MinRelayTxFee                   float64       `long:"minrelaytxfee" description:"The minimum transaction fee in SPR/kB to be considered a non-zero fee."`
...
// Config defines the configuration options for spectred.
//
// See loadConfig for details on the configuration load process.
type Config struct {
	*Flags
...
// DefaultConfig returns the default spectred configuration
...
//
// The above results in spectred functioning properly without any config settings
...
// createDefaultConfig copies the file sample-spectred.conf to the given destination path,
