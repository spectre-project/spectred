...
import (
	...
	"github.com/spectre-project/spectred/infrastructure/network/netadapter/server/grpcserver"
...
func (c *GRPCClient) mutexSend(request *protowire.SpectredMessage) error {
	c.streamLock.RLock()
...
func (c *GRPCClient) mutexReceive() (*protowire.SpectredMessage, error) {
	c.streamLock.RLock()
	defer c.streamLock.RUnlock()
