...
func (x *SpectredMessage_GetMempoolEntryRequest) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "SpectredMessage_GetMempoolEntryRequest is nil")
	}
	return x.GetMempoolEntryRequest.toAppMessage()
}

func (x *SpectredMessage_GetMempoolEntryRequest) fromAppMessage(message *appmessage.GetMempoolEntryRequestMessage) error {
...
func (x *SpectredMessage_GetMempoolEntryResponse) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "SpectredMessage_GetMempoolEntryResponse is nil")
	}
	return x.GetMempoolEntryResponse.toAppMessage()
}

func (x *SpectredMessage_GetMempoolEntryResponse) fromAppMessage(message *appmessage.GetMempoolEntryResponseMessage) error {
	var rpcErr *RPCError
