...
func (x *SpectredMessage_Version) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "SpectredMessage_Version is nil")
	}
...
func (x *VersionMessage) toAppMessage() (appmessage.Message, error) {
	...
	//  Full spectre nodes set SubnetworkId==nil
	if err != nil && !errors.Is(err, errorNil) {
		return nil, err
	}
...
func (x *SpectredMessage_Version) fromAppMessage(msgVersion *appmessage.MsgVersion) error {
