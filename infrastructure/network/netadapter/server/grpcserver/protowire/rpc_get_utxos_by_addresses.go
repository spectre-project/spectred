...
func (x *SpectredMessage_GetUtxosByAddressesRequest) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "SpectredMessage_GetUtxosByAddressesRequest is nil")
	}
	return x.GetUtxosByAddressesRequest.toAppMessage()
}

func (x *SpectredMessage_GetUtxosByAddressesRequest) fromAppMessage(message *appmessage.GetUTXOsByAddressesRequestMessage) error {
...
func (x *SpectredMessage_GetUtxosByAddressesResponse) toAppMessage() (appmessage.Message, error) {
	if x == nil {
...
func (x *SpectredMessage_GetUtxosByAddressesResponse) fromAppMessage(message *appmessage.GetUTXOsByAddressesResponseMessage) error {
	var err *RPCError
