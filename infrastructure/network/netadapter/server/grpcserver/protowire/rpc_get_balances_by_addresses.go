...
func (x *SpectredMessage_GetBalancesByAddressesRequest) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "SpectredMessage_GetBalanceByAddressRequest is nil")
	}
	return x.GetBalancesByAddressesRequest.toAppMessage()
}

func (x *SpectredMessage_GetBalancesByAddressesRequest) fromAppMessage(message *appmessage.GetBalancesByAddressesRequestMessage) error {
...
func (x *SpectredMessage_GetBalancesByAddressesResponse) toAppMessage() (appmessage.Message, error) {
	if x == nil {
...
func (x *SpectredMessage_GetBalancesByAddressesResponse) fromAppMessage(message *appmessage.GetBalancesByAddressesResponseMessage) error {
	var err *RPCError
