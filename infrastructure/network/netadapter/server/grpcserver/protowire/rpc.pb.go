...
//
// Clients are expected to build RequestMessages and wrap them in SpectredMessage. (see messages.proto)
//
// Having received a RequestMessage, (wrapped in a SpectredMessage) the RPC server will respond with a
// ResponseMessage (likewise wrapped in a SpectredMessage) respective to the original RequestMessage.
//
