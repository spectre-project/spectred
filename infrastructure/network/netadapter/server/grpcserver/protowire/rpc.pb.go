...
//
// Clients are expected to build RequestMessages and wrap them in SpectredMessage.
// (see messages.proto)
//
// Having received a RequestMessage, (wrapped in a SpectredMessage) the RPC server
// will respond with a ResponseMessage (likewise wrapped in a SpectredMessage)
...
// GetCurrentNetworkRequestMessage requests the network spectred is currently
// running against.
//
...
type GetBlockTemplateResponseMessage struct {
	...
	// Callers are discouraged (but not forbidden) from solving blocks when spectred
	// is not synced. That is because when spectred isn't in sync with the rest of
...
// GetPeerAddressesRequestMessage requests the list of known spectred addresses in
...
// peers currently connected to this spectred.
...
// selected parent chain from some startHash to this spectred's current virtual
...
// this spectred's current virtual.
...
// spectred. Note that this number may decrease as pruning occurs.
...
var file_rpc_proto_rawDesc = []byte{
	...
	0x63, 0x6f, 0x6d, 0x2f, 0x73, 0x70, 0x65, 0x63, 0x74, 0x72, 0x65, 0x2d, 0x70, 0x72, 0x6f, 0x6a,
	0x65, 0x63, 0x74, 0x2f, 0x73, 0x70, 0x65, 0x63, 0x74, 0x72, 0x65, 0x64, 0x2f, 0x70, 0x72, 0x6f,
...
func file_rpc_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_rpc_proto_msgTypes[108].Exporter = func(v any, i int) any {
		...
		file_rpc_proto_msgTypes[109].Exporter = func(v any, i int) any {
		...
		file_rpc_proto_msgTypes[110].Exporter = func(v any, i int) any {
		...
		file_rpc_proto_msgTypes[111].Exporter = func(v any, i int) any {
		...
		file_rpc_proto_msgTypes[112].Exporter = func(v any, i int) any {
		...
		file_rpc_proto_msgTypes[113].Exporter = func(v any, i int) any {
		...
		file_rpc_proto_msgTypes[114].Exporter = func(v any, i int) any {
		...
		file_rpc_proto_msgTypes[115].Exporter = func(v any, i int) any {
		...
		file_rpc_proto_msgTypes[116].Exporter = func(v any, i int) any {
		...
		file_rpc_proto_msgTypes[117].Exporter = func(v any, i int) any {
		...
		file_rpc_proto_msgTypes[118].Exporter = func(v any, i int) any {
		...
		file_rpc_proto_msgTypes[119].Exporter = func(v any, i int) any {
		...
		file_rpc_proto_msgTypes[120].Exporter = func(v any, i int) any {
		...
		file_rpc_proto_msgTypes[121].Exporter = func(v any, i int) any {
		...
		file_rpc_proto_msgTypes[122].Exporter = func(v any, i int) any {
		...
		file_rpc_proto_msgTypes[123].Exporter = func(v any, i int) any {
		...
		file_rpc_proto_msgTypes[124].Exporter = func(v any, i int) any {
		...
		file_rpc_proto_msgTypes[125].Exporter = func(v any, i int) any {
		...
		file_rpc_proto_msgTypes[126].Exporter = func(v any, i int) any {
		...
		file_rpc_proto_msgTypes[127].Exporter = func(v any, i int) any {
		...
		file_rpc_proto_msgTypes[128].Exporter = func(v any, i int) any {
		...
		file_rpc_proto_msgTypes[129].Exporter = func(v any, i int) any {
		...
		file_rpc_proto_msgTypes[130].Exporter = func(v any, i int) any {
		...
		file_rpc_proto_msgTypes[131].Exporter = func(v any, i int) any {
		...
		file_rpc_proto_msgTypes[132].Exporter = func(v any, i int) any {
		...
		file_rpc_proto_msgTypes[133].Exporter = func(v any, i int) any {
		...
		file_rpc_proto_msgTypes[134].Exporter = func(v any, i int) any {
		...
		file_rpc_proto_msgTypes[135].Exporter = func(v any, i int) any {
		...
		file_rpc_proto_msgTypes[136].Exporter = func(v any, i int) any {
		...
		file_rpc_proto_msgTypes[137].Exporter = func(v any, i int) any {
		...
		file_rpc_proto_msgTypes[138].Exporter = func(v any, i int) any {
