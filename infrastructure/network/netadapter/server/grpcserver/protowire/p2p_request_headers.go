...
func (x *SpectredMessage_RequestHeaders) toAppMessage() (appmessage.Message, error) {
	if x == nil {
...
func (x *SpectredMessage_RequestHeaders) fromAppMessage(msgRequestHeaders *appmessage.MsgRequestHeaders) error {
