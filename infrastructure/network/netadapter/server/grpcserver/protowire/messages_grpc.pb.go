...
type P2PClient interface {
	MessageStream(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[SpectredMessage, SpectredMessage], error)
}
...
func (c *p2PClient) MessageStream(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[SpectredMessage, SpectredMessage], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &P2P_ServiceDesc.Streams[0], P2P_MessageStream_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[SpectredMessage, SpectredMessage]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type P2P_MessageStreamClient = grpc.BidiStreamingClient[SpectredMessage, SpectredMessage]

// P2PServer is the server API for P2P service.
// All implementations must embed UnimplementedP2PServer
// for forward compatibility.
type P2PServer interface {
	MessageStream(grpc.BidiStreamingServer[SpectredMessage, SpectredMessage]) error
...
func (UnimplementedP2PServer) MessageStream(grpc.BidiStreamingServer[SpectredMessage, SpectredMessage]) error {
...
func _P2P_MessageStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(P2PServer).MessageStream(&grpc.GenericServerStream[SpectredMessage, SpectredMessage]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type P2P_MessageStreamServer = grpc.BidiStreamingServer[SpectredMessage, SpectredMessage]
...
func (c *rPCClient) MessageStream(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[SpectredMessage, SpectredMessage], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type RPC_MessageStreamClient = grpc.BidiStreamingClient[SpectredMessage, SpectredMessage]
...
func (UnimplementedRPCServer) MessageStream(grpc.BidiStreamingServer[SpectredMessage, SpectredMessage]) error {
	return status.Errorf(codes.Unimplemented, "method MessageStream not implemented")
}
...
func _RPC_MessageStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(RPCServer).MessageStream(&grpc.GenericServerStream[SpectredMessage, SpectredMessage]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type RPC_MessageStreamServer = grpc.BidiStreamingServer[SpectredMessage, SpectredMessage]
