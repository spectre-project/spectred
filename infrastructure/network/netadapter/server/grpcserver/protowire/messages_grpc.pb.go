...
type P2P_MessageStreamClient interface {
	Send(*SpectredMessage) error
	Recv() (*SpectredMessage, error)
	grpc.ClientStream
}
...
func (x *p2PMessageStreamClient) Send(m *SpectredMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *p2PMessageStreamClient) Recv() (*SpectredMessage, error) {
	m := new(SpectredMessage)
...
func (x *p2PMessageStreamServer) Send(m *SpectredMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *p2PMessageStreamServer) Recv() (*SpectredMessage, error) {
	m := new(SpectredMessage)
...
func (x *rPCMessageStreamClient) Send(m *SpectredMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *rPCMessageStreamClient) Recv() (*SpectredMessage, error) {
	m := new(SpectredMessage)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *rPCMessageStreamServer) Send(m *SpectredMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *rPCMessageStreamServer) Recv() (*SpectredMessage, error) {
	m := new(SpectredMessage)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
