...
func (x *SpectredMessage_GetPeerAddressesRequest) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "SpectredMessage_GetPeerAddressesRequest is nil")
	}
	return &appmessage.GetPeerAddressesRequestMessage{}, nil
}

func (x *SpectredMessage_GetPeerAddressesRequest) fromAppMessage(_ *appmessage.GetPeerAddressesRequestMessage) error {
	return nil
}

func (x *SpectredMessage_GetPeerAddressesResponse) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "SpectredMessage_GetPeerAddressesResponse is nil")
	}
	return x.GetPeerAddressesResponse.toAppMessage()
}

func (x *SpectredMessage_GetPeerAddressesResponse) fromAppMessage(message *appmessage.GetPeerAddressesResponseMessage) error {
	var err *RPCError
