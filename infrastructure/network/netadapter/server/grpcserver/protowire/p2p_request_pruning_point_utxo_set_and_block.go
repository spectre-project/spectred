...
func (x *SpectredMessage_RequestPruningPointUTXOSet) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "SpectredMessage_RequestPruningPointUTXOSet is nil")
	}
...
func (x *SpectredMessage_RequestPruningPointUTXOSet) fromAppMessage(
