...
func (x *SpectredMessage_Addresses) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "SpectredMessage_Addresses is nil")
	}
...
func (x *SpectredMessage_Addresses) fromAppMessage(msgAddresses *appmessage.MsgAddresses) error {
