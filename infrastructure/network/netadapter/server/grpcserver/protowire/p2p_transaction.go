...
func (x *SpectredMessage_Transaction) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "SpectredMessage_Transaction is nil")
	}
	return x.Transaction.toAppMessage()
}

func (x *SpectredMessage_Transaction) fromAppMessage(msgTx *appmessage.MsgTx) error {
