...
func (x *SpectredMessage_NotifyUtxosChangedRequest) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "SpectredMessage_NotifyUtxosChangedRequest is nil")
	}
	return x.NotifyUtxosChangedRequest.toAppMessage()
}

func (x *SpectredMessage_NotifyUtxosChangedRequest) fromAppMessage(message *appmessage.NotifyUTXOsChangedRequestMessage) error {
...
func (x *SpectredMessage_NotifyUtxosChangedResponse) toAppMessage() (appmessage.Message, error) {
	if x == nil {
...
func (x *SpectredMessage_NotifyUtxosChangedResponse) fromAppMessage(message *appmessage.NotifyUTXOsChangedResponseMessage) error {
	var err *RPCError
...
func (x *SpectredMessage_UtxosChangedNotification) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "SpectredMessage_UtxosChangedNotification is nil")
	}
	return x.UtxosChangedNotification.toAppMessage()
}

func (x *SpectredMessage_UtxosChangedNotification) fromAppMessage(message *appmessage.UTXOsChangedNotificationMessage) error {
