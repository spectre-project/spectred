...
func (x *SpectredMessage_Block) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "SpectredMessage_Block is nil")
	}
	return x.Block.toAppMessage()
}

func (x *SpectredMessage_Block) fromAppMessage(msgBlock *appmessage.MsgBlock) error {
