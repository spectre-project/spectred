...
type grpcStream interface {
	Send(*protowire.SpectredMessage) error
	Recv() (*protowire.SpectredMessage, error)
}
...
func (c *gRPCConnection) receive() (*protowire.SpectredMessage, error) {
...
func (c *gRPCConnection) send(message *protowire.SpectredMessage) error {
