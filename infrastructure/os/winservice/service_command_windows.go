...
// installService attempts to install the spectred service. Typically this should
...
// removeService attempts to uninstall the spectred service. Typically this should
...
// startService attempts to Start the spectred service.
