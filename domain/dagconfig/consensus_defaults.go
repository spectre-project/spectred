...
const (
	...
	defaultSubsidyGenesisReward                    = 1 * constants.SompiPerSpectre
	defaultPreDeflationaryPhaseBaseSubsidy         = 15 * constants.SompiPerSpectre
	defaultDeflationaryPhaseBaseSubsidy            = 12 * constants.SompiPerSpectre
	...
	defaultDeflationaryPhaseDaaScore = 604800
