...
import (
	...
	"github.com/spectre-project/spectred/util/network"
...
// Params defines a Spectre network by its parameters. These parameters may be
// used by Spectre applications to differentiate networks as well as addresses
...
type Params struct {
	...
	// PruningProofM is the 'm' constant in the pruning proof. For more details see: https://github.com/spectre-project/research/issues/3
...
// MainnetParams defines the network parameters for the main Spectre network.
var MainnetParams = Params{
	K:           defaultGHOSTDAGK,
	Name:        "spectre-mainnet",
	...
	Prefix: util.Bech32PrefixSpectre,
...
// TestnetParams defines the network parameters for the test Spectre network.
var TestnetParams = Params{
	K:           defaultGHOSTDAGK,
	Name:        "spectre-testnet-1",
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixSpectreTest,
...
// SimnetParams defines the network parameters for the simulation test Spectre
...
var SimnetParams = Params{
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixSpectreSim,
...
// DevnetParams defines the network parameters for the development Spectre network.
var DevnetParams = Params{
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixSpectreDev,
...
// ErrDuplicateNet describes an error where the parameters for a Spectre
// network could not be set due to the network already being a standard
// network or previously-registered into this package.
var ErrDuplicateNet = errors.New("duplicate Spectre network")

var registeredNets = make(map[appmessage.SpectreNet]struct{})

// Register registers the network parameters for a Spectre network. This may
