...
func (v *transactionValidator) checkTransactionAmountRanges(tx *externalapi.DomainTransaction) error {
	...
	// as a sompi. One spectre is a quantity of sompi as defined by the
	// sompiPerSpectre constant.
	...
	for _, txOut := range tx.Outputs {
		...
		// This is impossible for Spectre, but perhaps possible if an alt increases
