...
import (
	...
	"github.com/spectre-project/spectred/domain/consensus/utils/virtual"
...
func (v *blockValidator) checkCoinbaseSubsidy(
	...
	for _, parent := range parents {
		...
		// The pruning proof ( https://github.com/spectre-project/docs/blob/main/Reference/prunality/Prunality.pdf ) concludes
