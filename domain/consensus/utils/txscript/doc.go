...
spectre transaction scripts.

# Script Overview

Spectre transaction scripts are written in a stack-base, FORTH-like language.

The spectre script language consists of a number of opcodes which fall into
...
Typical spectre scripts at the time of this writing are of several standard
...
what conditions must be met in order to spend spectre.
