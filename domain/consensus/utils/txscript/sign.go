...
// SignatureScript creates an input signature script for tx to spend SPR sent
...
// SignatureScriptECDSA creates an input signature script for tx to spend SPR sent
